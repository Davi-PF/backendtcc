...
public class EmailHandlerVO extends RepresentationModel<EmailHandlerVO> implements Serializable {
    ...
    public EmailHandlerVO() {
    }

    public EmailHandlerVO(int key, Timestamp sendDate, Timestamp returnDate, String emailUser, String cpfDep) {
        this.key = key;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmailHandlerVO vo)) return false;
